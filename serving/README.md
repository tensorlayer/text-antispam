...
~~TensorFlow Serving的编译依赖Google的开源编译工具Bazel。具体的安装可以参考[官方文档]~~(https://docs.bazel.build/versions/master/install-compile-source.html)。现在通过Docker使用Tensorflow Serving已经非常方便了，建议大家直接参考[TensorFlow Serving with Docker]这篇文档安装TensorFlow Serving。
